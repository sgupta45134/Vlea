...
function theme_mb2nl_course_content()
{
    ...
    elseif ( theme_mb2nl_theme_setting( $PAGE, 'courseplimg' ) )
    {
	...
	$content = theme_mb2nl_wordlimit(format_text($COURSE->summary), $limit);
 ...
 *
 */
function theme_mb2nl_panel_link ($pos = 'content')
{
    global $PAGE, $COURSE;
