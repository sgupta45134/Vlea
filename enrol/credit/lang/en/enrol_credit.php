...
$string['checkout'] = '{$a->credit_cost} credits will be deducted from your balance of {$a->user_credits} credits.';
...
$string['insufficient_credits'] = 'You have insufficient course credits to enroll into this course. {$a->credit_cost} credits are required, your balance is {$a->user_credits}. Please top-up your credits.
   {$a->button}';
