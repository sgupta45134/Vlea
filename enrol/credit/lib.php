...
class enrol_credit_plugin extends enrol_plugin {
    ...
    public function can_self_enrol(stdClass $instance, $checkuserenrolment = true) {
        ...
        $url = new moodle_url('/local/stripepayment/');
        $button .= "<br><a href=$url class= btn btn-primary>Process to top up</a>";
        $insufficient_balance = get_string('insufficient_credits', 'enrol_credit', [
