...
if ($hassiteconfig) {
  $settings = new admin_settingpage('local_custom', 'Set address here to receive payment email:');

  // Create 
  $ADMIN->add('localplugins', $settings);
  $settings->add(new admin_setting_configtext('local_custom/email', get_string('email', 'local_send_mail_user_create_complete'), get_string('emaildescp', 'local_send_mail_user_create_complete'), '', PARAM_TEXT, 30));
