...
require_once($CFG->dirroot . '/local/stripepayment/print_user_profile_form.php');
...
$PAGE->set_url('/local/print_user_profile.php', array('course' => $course, 'id' => $id));
...
// Create form.
$userform = new print_user_profile_form(new moodle_url($PAGE->url, array('returnto' => $returnto)), array(
