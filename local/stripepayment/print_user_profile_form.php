 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class print_user_profile_form extends moodleform {
...
//        $mform->setType('username', PARAM_RAW);
        ...
        $mform->addElement('text', 'firstname1', get_string('firstname'), 'size="20"');
        $mform->setDefault('firstname1', $user->firstname);
        $mform->setType('firstname1', PARAM_RAW);
        
        $mform->addElement('text', 'lastname1', get_string('lastname'), 'size="20"' );
        $mform->setDefault('lastname1', $user->lastname);
        $mform->setType('lastname1', PARAM_RAW);
        
        $mform->addElement('text', 'email1', get_string('email'), 'size="50"' );
        $mform->setDefault('email1', $user->email);
        $mform->setType('email1', PARAM_RAW);
